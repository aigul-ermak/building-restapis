...
namespace DevHabit.Migrations.Application
{
    ...
    [Migration("20250617170607_AddHabitTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Entities.Habit", b =>
                {
                    ...
                    b.Property<DateTime?>("LastCompleteAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_complete_at_utc");
            ...
            modelBuilder.Entity("DevHabit.Entities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Entities.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DevHabit.Entities.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("DevHabit.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
